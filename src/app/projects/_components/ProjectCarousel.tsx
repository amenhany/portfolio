...
function RedArrow({
   ...
   return (
      <motion.div
         className={`red-arrow z-50 absolute ${direction === 'left' ? 'lg:left-[23vw] sm:left-[15vw] left-[20vw] -rotate-90' : 'lg:right-[23vw] sm:right-[15vw] right-[20vw] rotate-90'} bottom-[2vh] sm:bottom-auto`}
